	...
	<header class="entry-header">
		...
		<?php
			...
			if ( is_single() ) :
				...
				the_title( sprintf( '<h1 class="entry-title"><a href="%s">', esc_url( o3pink_get_link_url() ) ), '</a></h1>' );

			else :

				the_title( sprintf( '<h2 class="entry-title"><a href="%s">', esc_url( o3pink_get_link_url() ) ), '</a></h2>' );
