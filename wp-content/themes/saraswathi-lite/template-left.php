...
/**
 *
 * Template Name:  Pages - Content Left, Sidebar Right
 *
 * Template for creating landing pages with right sidebar.
 *
...
?>
<?php saraswathi_get_template_part( 'saraswathi', 'template', 'left' ); ?>
