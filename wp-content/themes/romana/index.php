            ...
            <div class="row">
                 <div class="col-md-12">
                    <div class="page-title">
                        <?php if(!empty(get_option( 'page_for_posts' )) ): ?>
                            <h1><?php echo get_the_title(get_option( 'page_for_posts' )); ?></h1>
                        <?php else: ?>
                            <h1><?php esc_html_e('BLOG','romana'); ?></h1>
                        <?php endif; ?>
...
<div class="container">
    <div class="row">
	                ...
	                <article class="post-publish">
                        ...
                        <?php if(get_theme_mod('romana_hide_date_sec') != 0 || get_theme_mod('romana_hide_author_sec') != 0): ?>    
                            ...
                            <?php endif;
	                           ...
	                           <span class="byline"><?php esc_html_e('By ','romana'); ?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="<?php echo esc_attr(ucfirst(get_the_author())); ?>"><?php echo esc_html(ucfirst(get_the_author())); ?></a>
                               </span>
                            <?php endif; ?>   
	                    </div>
                    <?php endif; ?>
        ...
        <!-- Side bar -->
        <?php if(get_theme_mod('romana_sidebar_layout')!='none'){
        get_sidebar(); }?>
    </div>
</div>
<?php get_footer(); ?>